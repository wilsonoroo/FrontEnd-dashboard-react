...
import DivisionCard from "../gerencias/components/DivionesCard/DivisionCard";
...
export default function DetalleGerenciaSuperAdminConfig(props: { titulo: string }) {
const { titulo } = props;
...
const handleClickDetalle = (item: any) => {
    navigate("/superAdmin/" + idEmpresa + `/${idGerencia}/` + item.id, {
    state: {
        empresa: {
        id: empresa.id,
        nombre: empresa.nombre,
